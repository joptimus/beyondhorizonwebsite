...
export const SHIPS: ShipDisplay[] = [
  ...
  },
  {
    ...
    summary: 'Designed as the strategic nerve center of Voranâ€™s fleets, the Vanguard fuses advanced tactical computation with heavy carrier capacity.',
  ...
  },
  {
    ...
    name: 'VX-4B Falchion',
    role: 'Escort and line destroyer',
    summary: 'Standard fleet destroyer configuration â€" balanced armor and firepower.',
    description: 'The VX-4B Falchion is Voran\'s standard fleet destroyer configuration â€" a balanced blend of armor, speed, and configurable firepower that forms the backbone of many midline squadrons. Its modular hardpoints allow commanders to refit the ship as a point-defense escort, line-brawler, or long-range fire support platform without altering core systems. Robust plating and redundant field generators give the Falchion surprising resilience for its class, enabling it to hold the line while heavier hulls maneuver into position. In the Beyond Horizon frontier, Falchions are often the first warships colonists see flying Voran colors, escorting convoys and imposing the corporation\'s claims with calm, methodical discipline. Unremarkable at a glance, they are the dependable edge of the blade that makes spectacular victories possible.',
    tags: ['warship', 'destroyer'],
    class: 'destroyer'
  },
  {
  ...
  },
  {
    ...
    role: 'Super-heavy capital dreadnought',
    summary: 'The flagship configuration â€" immense, balanced, and terrifyingly efficient.',
    description: 'The VX-8C Leviathan is the flagship configuration of the VX-8 line â€" immense, balanced, and terrifyingly efficient in every role demanded of a super-heavy dreadnought. Its long-range mass drivers can pummel targets from beyond conventional engagement envelopes, while layered shield harmonics allow it to weather sustained fire over protracted sieges. Internally, the Leviathan carries expanded command suites, diplomatic compartments, and hardened data-cores that turn it into a roaming seat of Voran authority. Fleets organized around a Leviathan become more than military assets; they are mobile capitals, dragging the center of political gravity with them wherever they jump. In the Beyond Horizon era, entire sectors define their history as â€œbefore the Leviathan arrivedâ€ and â€œafter it left,â€ measuring time by the shadow of its passage.',
    tags: ['warship', 'dreadnought', 'command'],
    class: 'dreadnought'
  },
  {
